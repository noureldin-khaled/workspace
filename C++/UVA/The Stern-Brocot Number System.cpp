...
void f(int node1, int node2, int left1, int left2, int right1, int right2);
int main()
{
	while(true)
	{
...
void f(int node1, int node2, int left1, int left2, int right1, int right2)
{
	...
	{
		printf("L");
		f(node1+left1, node2+left2, left1, left2, node1, node2);
	}
	else
	{
		printf("R");
		f(node1+right1, node2+right2, node1, node2, right1, right2);
	}
}
