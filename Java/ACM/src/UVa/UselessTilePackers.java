...
public class UselessTilePackers {
	...
	public static void main(String[] args) throws IOException {
		...
		while(true) {
			...
			Polygon inner = new Polygon(arr, false);
			Polygon outer = Polygon.convexHull(arr);
			
			double innerArea = inner.area();
			double outerArea = outer.area();
			
			out.printf("Tile #%d\nWasted Space = %.2f",t++,((outerArea - innerArea) / outerArea) * 100.0);
			out.println(" %\n");
		}
